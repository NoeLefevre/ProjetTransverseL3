...
let btncommentaire2 = document.querySelector(".btncom2");
let txtcom = document.querySelector(".form");
const contenu1 = document.querySelectorAll(".contenu1");
const contenu2 = document.querySelectorAll(".contenu2");

btncommentaire.addEventListener("click",afficher_ecrire_commentaire)
btncommentaire2.addEventListener("click",rentrer_ecrire_commentaire)
boutonnoter.addEventListener("click",afficher_menu_noter)
boutonnoter2.addEventListener("click",rentrer_menu_noter)
if (modifnote != undefined)
    modifnote.addEventListener("click",modif_note)
if (etoile1 != undefined && etoile2 != undefined && etoile3 != undefined &&  etoile4 != undefined && etoile5 != undefined)
{
...
if (etoile1j != undefined && etoile2j != undefined && etoile3j != undefined &&  etoile4j != undefined && etoile5j != undefined)
{
...
function afficher_ecrire_commentaire(){
    btncommentaire.style.display = "none";
    btncommentaire2.style.display = "block";
    txtcom.style.display = "block";
}
function rentrer_ecrire_commentaire(){
    btncommentaire.style.display = "block";
    btncommentaire2.style.display = "none";
