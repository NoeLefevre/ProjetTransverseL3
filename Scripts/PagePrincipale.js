...
let compt =  document.getElementById("hidden").textContent;
let ListeEvenement = document.getElementById("hidden2").textContent;
ListeEvenement = JSON.parse(ListeEvenement);
for (let i=0;i<compt;i++)
{
	document.addEventListener('DOMContentLoaded', function() {
	var calendarEl = document.getElementById("calendar"+i.toString());
